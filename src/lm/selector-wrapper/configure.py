...
os.system(" ".join([config.sip_bin, "-c", ".", "-b", build_file, "selector-wrapper.sip"]))

# Create the Makefile.
# Installation path is within the project, not central (DEST_DIR won't work correctly)
makefile = sipconfig.SIPModuleMakefile(config, build_file, install_dir=os.path.abspath(".."), makefile="Makefile")
...
extra_bin_dirs = [
    os.path.abspath("../../../libs/ARPA-selector"),
    os.path.abspath("../../../libs/kenlm/bin/util"),
    os.path.abspath("../../../libs/kenlm/bin/lm")
]

# makefile.extra_lflags = [" ".join([os.path.join(bin, "*.o") for bin in extra_bin_dirs])] # unnecessary, included in kenlm-wrapper.o
makefile.extra_include_dirs = [os.path.abspath("../../../libs/ARPA-selector"), os.path.abspath("../../../libs/kenlm")]
